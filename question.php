...
if ($_SESSION["Ferid"]){
    ...
    if (isset($_POST['dergo_1'])) {
        ...
        if($totali1<1) {
            ...
            echo "Ju keni shtuar te dhena per ketezx imazh".$employee_id." ".$totali1;
        }
                                    ...
                                    for($i=1; $i<5; $i++){
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-item nav-link" data-bs-toggle="tab" href="#pyetja<?php echo $i;?>" role="tab" aria-selected="false">
                                                ...
                                                <span class="d-none d-sm-block">Foto<?php echo $i;?></span>
                                            </a>
                                        </li>
                                        <?php
                                    }?>
                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    for($i=1; $i<5; $i++){
                                        ...
                                        <div class="tab-pane" id="pyetja<?php echo $i;?>" role="tabpanel">
                                            ...
                                            <img class="form-control" src="imgpyetjet/pyetja<?php echo $i;?>.jpg" alt="" />

                                            <form class="form-group" method='post' action='#pyetja<?php echo $i;?>'>
                                                ...
                                                <button name='dergo_<?php echo $i;?>' class="btn btn-primary" value="#settings" >Shto<?php echo $i;?></button>
                                            </form>
                                        </div>
                                        <?php
                                    }
